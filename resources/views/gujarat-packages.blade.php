...
@section('content')
        ...
        <div class="col-lg-12">
            <div class="imgArea">
              <img src="{{ asset('public/img/packages/gujarat-banner.jpeg')}}" class="rounded-top w-100" alt="Logo">
            </div>
        </div>
       ...
       <div class="container py-5">
            <div class="row g-5">
                @if(count($gujaratPackagesList)>0)
                  @foreach($gujaratPackagesList as $key => $list)
