...
@section('content')
        ...
        <div class="col-lg-12">
            <div class="imgArea">
              <img src="{{ asset('public/img/packages/sikkim-banner-new.jpg')}}" class="rounded-top w-100" alt="Logo">
            </div>
        </div>
       ...
       <div class="container py-5">
            <div class="row g-5">
                @if(count($northEastPackagesList)>0)
                  @foreach($northEastPackagesList as $key => $list)
