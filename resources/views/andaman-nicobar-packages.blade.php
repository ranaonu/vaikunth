...
@section('content')
        ...
        <div class="col-lg-12">
            <div class="imgArea">
              <img src="{{ asset('public/img/packages/banner-andaman_1760530137.jpg')}}" class="rounded-top w-100" alt="Logo">
            </div>
        </div>
       ...
       <div class="container py-5">
            <div class="row g-5">
                @if(count($andamanNicobarPackagesList)>0)
                  @foreach($andamanNicobarPackagesList as $key => $list)
