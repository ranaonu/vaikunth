...
@section('content')
        ...
        <div class="col-lg-12">
            <div class="imgArea">
              <img src="{{ asset('public/img/packages/jammu-kashmir-banner.webp')}}" class="rounded-top w-100" alt="Logo">
            </div>
        </div>
       ...
       <div class="container py-5">
            <div class="row g-5">
                @if(count($kashmirPackagesList)>0)
                  @foreach($kashmirPackagesList as $key => $list)
