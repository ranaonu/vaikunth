...
@section('content')
        ...
        <div class="col-lg-12">
            <div class="imgArea">
              <img src="{{ asset('public/img/packages/odisha-tourism-2.webp')}}" class="rounded-top w-100" alt="Logo">
            </div>
        </div>
       ...
       <div class="container py-5">
            <div class="row g-5">
                @if(count($odishaPackagesList)>0)
                  @foreach($odishaPackagesList as $key => $list)
